...
public class EarthquakeCityMap extends PApplet {
	...
	private void quakeNearyou(double longtude, double lattude) {
		System.out.println("Earthquakes that are under 1000KM from your location: ");
		for (Marker m: quakeMarkers) {
			double xcord = m.getLocation().x;
			double ycord = m.getLocation().y;
	  
	        // Haversine formula  
	        double dlon = Math.toRadians(longtude-xcord);  
	        double dlat = Math.toRadians(lattude-ycord); 
	        double a = Math.pow(Math.sin(dlat / 2), 2) 
	                 + Math.cos(lattude) * Math.cos(ycord) 
	        ...
	        if (d<=1000 && d!=0) {
	        	...
	        	System.out.print(" ");
	        	System.out.print(d);
	        	System.out.print("km from your location");
	        	System.out.println();
	        }
		}
	}
